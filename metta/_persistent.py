...
% removals. library(persistency) generates both update predicates, and this is the
...
%native world update. library(persistency) journals each updater as an ordinary
