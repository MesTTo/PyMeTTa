...
def _validated_scheme(
    ...
    # policy-inventory-exempt: mechanism-internal; reason=http and https are the two transports implemented by HTTPEndpoint; evidence=extensions/python/metta/_network.py:_validated_scheme
