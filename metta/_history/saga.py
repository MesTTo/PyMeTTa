...
from metta._binding.dispatch import (
...
from metta.foreign import Adder, Enumerable, Remover, Transactional
...
class Saga:
    ...
    def __init__(self, space: _space_face.Space, receipts: _space_face.Space) -> None:
...
@_doors.door(
    ...
    refuses=(_doors.Refusal(_doors.RefusalKind.type, 'extensions/python/tests/repository/test_door_refusals.py::test_door_type_refusals[space:saga]'),),
)
def saga(space: _space_face.Space, receipts: _space_face.Space):
