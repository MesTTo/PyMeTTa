...
def current() -> str | None:
    ...
    if _callbacks.entered():
        from metta._binding.runtime import (  # noqa: PLC0415 -- engine imports this context
            active_runtime,
        )
