...
class _EvaluationGroup:
    ...
    def __init__(self, owner: _aio__worker.AsyncMeTTaBase) -> None:
        self.owner = owner
    ...
    async def open(self, execute: Callable[[_root.Space], Any], *, batch: bool) -> Any:
        ...
        async with self._opening:
            ...
            try:
                ...
                def capture(space: _root.Space) -> None:
