...
class AsyncMeTTa(AsyncMeTTaBase):
    ...
    async def match(
        ...
        **values: _body_typing.Any,
        ...
        """
        return await self.call(lambda m: m.match(*patterns, where=where, limit=limit, timeout=timeout, inferences=inferences, under=under, into=into, derivations=derivations, **values))
    ...
    async def algebra(
        ...
        *,
        ...
        and its tag.
        """
        return await self.call(lambda m: m.algebra(name, combine=combine, extend=extend, zero=zero, one=one, laws=laws, carrier=carrier, type=type, requires=requires, order=order, negate=negate, saturated=saturated, variable=variable))
    ...
    async def add_tagged_rule(
        ...
        *premises: _body_typing.Any,
        ...
        """
        return await self.call(lambda m: m.add_tagged_rule(tag, head, *premises, where=where))
