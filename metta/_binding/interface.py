...
CALLBACK_GROUPS: dict[str, tuple[Export, ...]] = {
    ...
    "metta.foreign": (
        "foreign_add", "foreign_add_many", "foreign_atoms", "foreign_tokens",
        "foreign_clear", "foreign_match", "foreign_plan", "foreign_pushdown",
        "foreign_refuse", "foreign_remove", "foreign_transaction",
        "is_matchable", "match_object",
    ),
    "metta.paths": (
