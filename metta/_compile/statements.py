...
def _space_valued(value: Atom) -> bool:
    ...
    if isinstance(value, Expression) and value.children:
        ...
        # policy-inventory-exempt: mechanism-internal; reason=the three heads that mint or read a space in a compiled binding decide the += space-write reading and are not a value vocabulary; evidence=extensions/python/metta/_compile/statements.py:_space_valued
