...
if TYPE_CHECKING:
    import metta_arrays as _body_2  # type: ignore[import-not-found, unused-ignore]
    import metta_live as _body_3  # type: ignore[import-not-found, unused-ignore]
    import metta_pandas as _body_4  # type: ignore[import-not-found, unused-ignore]
    import metta_polars as _body_5  # type: ignore[import-not-found, unused-ignore]

    import metta.remote as _body_0
    import metta.tables as _body_1


class ArraysContext(Protocol):
    """The context members of the arrays accessor."""

    def install(self, default: _body_2.Any=...) -> list[str]:
...
class RemoteContext(Protocol):
    ...
    def serve(
        ...
        *,
        token: str | None=...,
        authorize: _body_0.Callable[[_body_0.Request], bool] | None=...,
        ssl_context: _body_0.Any=...,
        cursor_idle: float=...,
        cursor_limit: int=...,
        mutation_ttl: float=...,
...
class TablesContext(Protocol):
    ...
    def to_df(self, rows: _body_4.Any) -> _body_4.Any:
        """These rows as a pandas DataFrame; the declared point rows.to('pandas')."""
        ...

    def to_pl(self, rows: _body_5.Any) -> _body_5.Any:
        """These rows as a polars DataFrame; the declared point rows.to('polars')."""
        ...

    def add(self, head: _body_1.Any, data: _body_1.Any) -> int:
    ...
    def declare(self, name: str, declaration: _body_1.Atom | str) -> _body_1.Atom:
    ...
    def sql_function(self, connection: _body_1.Any, head: _body_1.Any, name: str | None=...) -> str:
