...
class Space(SpaceHandle):
    ...
    def match(
        ...
        **values: _body_typing.Any,
        ...
        """
        return _body_metta__spaces_query.match(self, *patterns, where=where, limit=limit, timeout=timeout, inferences=inferences, under=under, into=into, **values)
    ...
    def algebra(
        ...
        *,
        ...
        """
        return _body_metta__declare_declarations.algebra(self, name, combine=combine, extend=extend, zero=zero, one=one, laws=laws, carrier=carrier, type=type, requires=requires, order=order)
