...
_IMPORTS = {
    ...
    "Atom": "metta.atoms",
    "Symbol": "metta.atoms",
    "Variable": "metta.atoms",
    "Expression": "metta.atoms",
    "Grounded": "metta.atoms",
}
...
def _type_parameters(names: Sequence[str]) -> str:
...
def _module_documentation(sources: Sequence[str], space_name: str) -> list[str]:
...
def stubs(space: Space | Any, *, sources: Iterable[str | os.PathLike[str]] = ()) -> str:
