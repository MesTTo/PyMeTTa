...
from metta._atoms.factories import Atom, Symbol, _atom_from_wire, _to_atom
...
def _trace(space, source: Atom | str,
...
def trace(
    ...
    *,
    ...
    """  # noqa: D205  -- the API contract is one continuous invariant, not summary-and-body prose
    return _trace(
        space, source, max_events=max_events, filter=filter,
