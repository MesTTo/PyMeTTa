...
from metta._atoms.factories import Atom, _atom_from_wire, _to_atom
from metta._errors.errors import MettaError, Remedy, refusing
from metta._lazy import lazy
from metta._observe.debug import debug as _open_debugger
from metta._observe.trace import DEFAULT_MAX_EVENTS, Trace, TraceEvent, _as_source, _selected_names
from metta._observe.trace import _trace as _run_traced
from metta._spaces.scope import _RUN_BINDINGS
from metta._spaces.snapshot import (
    _open_maybe_gz,
    _sync_and_replace,
    _temporary_sibling,
    serializable,
...
from metta.vocabularies import EffectClass, Limit
...
def _record(space: Any, source: Atom | str, *,
           seed: int | None = None,
...
def record(
    ...
    *,
    ...
    """
    return _record(
        space, source, seed=seed, max_events=max_events,
