...
def _annotation_resolver(
    ...
    def resolve(node: ast.expr) -> Any:
        ...
        if isinstance(node, ast.Subscript):
            ...
            # policy-inventory-exempt: mechanism-internal; reason=only these three modules define the subscripts that are typing constructors, so subscripting anything else would run user code while resolving an annotation; evidence=extensions/python/metta/define.py:_annotation_resolver
