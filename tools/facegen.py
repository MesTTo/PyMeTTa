"""Purpose: keep every generated MeTTa face and the Python module it was read
from one authority, by regenerating each face from its own header and requiring
the result to equal the file that is checked in.
