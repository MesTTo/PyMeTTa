...
#: commit=cd62330ceacc8f1254eed9791c3f6203b48a1c9e]. 50,000 is two orders above the largest surplus the corpus
...
#: 2857, 4210, 5579, 6960 inferences at 1 to 4 definitions, the fit 1482
#: once plus 1368 for each; the source door reads 434 to store and 1023 at
#: its first call, the define door 2857 and 182. The per-definition cost had
...
#: 1368), and this tree moves the once-per-file warmup +70, the
...
#: predicates alone +30, its pattern table alone 0, both +70; +60 once the
...
#: Answers.count; ai-report-p14-r3.md corpus counts; commit=cd62330ceacc8f1254eed9791c3f6203b48a1c9e]
...
#: compiled into this space before claiming the hook"; commit=cd62330ceacc8f1254eed9791c3f6203b48a1c9e]
...
#: with Variable arguments; commit=cd62330ceacc8f1254eed9791c3f6203b48a1c9e].
...
def _stored(relative: str, twin: Path, left: Run, right: Run) -> list[str]:
    ...
    extensions/python/metta/_binding/store.pl:189, metta_py_atoms/2; commit=cd62330ceacc8f1254eed9791c3f6203b48a1c9e], so
