...
def documentation(records: tuple[Artifact, ...]) -> str:
    ...
    lines = [
        ...
        "The table and each gate's registrations follow declared dependencies; the umbrella runs `worktree` and "
        "`build` first, then every component's own lanes as it discovers them, then the rest of its own. "
