...
def test_no_shipped_prolog_source_depends_on_the_development_build(repo_root):
    ...
    engine/, lib/, extensions/mork/ or extensions/python/metta/ would make that
    false.
    """
    roots = [repo_root / name for name in ("engine", "lib")]
    roots.append(repo_root / "extensions" / "mork")
    roots.append(repo_root / "extensions" / "python" / "metta")
