"""Purpose: a Python module written to be read BY a face, one of each shape.

It carries one of each shape the face generator has a rule for, so the tests
derive a face from real signatures rather than from a description of them.
