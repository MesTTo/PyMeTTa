...
HOST_SERVICES = {
    ...
    "get_native_atom/2",
    "import_when/4",
    "load_imported_metta_file_impl/3",
    "match_foreign/5",
    "metta_add_atom/3",
    "metta_add_atoms/2",
    ...
    "petta_handles_route/5",
    "petta_on_error_mode/3",
    "petta_refuse_guard/2",
    "petta_source_reset/1",
    "petta_transaction/1",
    "petta_transport_failure/1",
    "prepare_parsed_forms/1",
    "process_form/3",
    "read_metta_source/2",
    "recompile_definitions_mentioning/1",
    "refuse_lossy_plan/4",
    "refuse_other_tiers_name/2",
    "register_fun_in/2",
    "release_function_name/1",
    "replacing_previous_load/4",
    "sread_with_names/3",
    "translate_expr/3",
    "translate_special_dl/5",
