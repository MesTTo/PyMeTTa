"""Purpose: the engine's per-runnable state belongs to the runnable, and a
caller's bound that was exceeded refuses instead of answering.

Both rules exist because a battery said so. A runnable's evaluation-fuel scope
