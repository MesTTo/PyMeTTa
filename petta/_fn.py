...
_DOCUMENTATION = {
    ...
    "<": "<: (-> Number Number Bool)\n\nPython's own operator.",
    "<=": "<=: (-> Number Number Bool)\n\nPython's own operator.",
    "=": "=: (-> $t $t %Undefined%)\n\nThe definitional decorator. `@m.define` compiles a function into equations, `petta.equation(lhs).to(rhs)` builds one by hand, and both land as ordinary `(= ...)` atoms a program can match.",
